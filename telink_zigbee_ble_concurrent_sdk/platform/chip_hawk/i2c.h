...
#define I2C_MASTER_EN   0  //1:enable master; 0:enable slave

/**
 *  @brief  Define I2C pin port
 */
typedef enum {
    I2C_PIN_GPIOA34 = 0,        // master and slave
	I2C_PIN_GPIOA56,			// master and slave
    I2C_PIN_GPIOB23,			// master only
	I2C_PIN_GPIOB67,			// master only
    I2C_PIN_GPIOC45,			// master and slave
} I2C_PinTypeDef;
/**
