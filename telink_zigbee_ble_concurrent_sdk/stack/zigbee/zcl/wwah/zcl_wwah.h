...
bool zcl_wwah_apsLinkKeyAuthCheck(u16 clusterID, bool apsUseSec);
bool zcl_wwah_apsAckRequirementCheck(u16 clusterID);
bool zcl_wwah_useTCForClusterCheck(u16 clusterID);
void zcl_wwah_periodicRouterChecked(void);
bool zcl_wwah_touchlinkEnabled(zclIncoming_t *pInMsg);
