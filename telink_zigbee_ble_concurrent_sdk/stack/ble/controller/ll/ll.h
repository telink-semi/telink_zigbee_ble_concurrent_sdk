...
/**
 * @brief:This function obtains the latest time point of the ble task that needs to be executed.
 * @param	none
 * @return	time value Range: 0 to 127000. time value(Units:microsecond)
 * 			 0us: BLE task is executing.
 * 			 127000us: The latest task is greater than 100ms, or no ble task needs to be executed.
 * 			 other:
 **/
unsigned int blc_ll_nextBLETaskRunTimeUs( void );
#endif /* LL_H_ */
