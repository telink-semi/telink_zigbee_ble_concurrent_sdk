...
#define CFG_FACTORY_RST_CNT			  	(0x25000)
 ...
 */
#define CFG_PRE_INSTALL_CODE			(0x8040)
...
#if FLASH_SIZE_1M
#define CFG_TELINK_SDK_TYPE				(0x24000)
#else
